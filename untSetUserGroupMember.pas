...
type
  TfrmSetUserGroupMember = class(TfrmMaster)
    Panel1: TPanel;
...
var
  frmSetUserGroupMember: TfrmSetUserGroupMember;
...
procedure TfrmSetUserGroupMember.btnCancelClick(Sender: TObject);
begin
  Close;
end;

procedure TfrmSetUserGroupMember.btnDeleteClick(Sender: TObject);
var
  s: string;
begin
...
procedure TfrmSetUserGroupMember.btnSaveClick(Sender: TObject);
var
  s: string;
begin
...
procedure TfrmSetUserGroupMember.FormCreate(Sender: TObject);
var
  AHandled: THandle;
  Chk, F1, F2: TField;
  s: string;
...
procedure TfrmSetUserGroupMember.AddMember(Sender: TObject);
begin

end;

procedure TfrmSetUserGroupMember.MemberGroupClick(Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo; AButton: TMouseButton;
  AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmSetUserGroupMember.SetCurrentUserGroup(const Value: integer);
var
  s: string;
  i: integer;
begin
